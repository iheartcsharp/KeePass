...
namespace KeePass.DataExchange.Formats
{
    ...
    internal sealed class PwSaverXml412 : FileFormatProvider
    {
        ...
        private static PwIcon GetIcon(string strName)
        {
            ...
            if (str == "HOSTING.ICO")
            {
                return PwIcon.NetworkServer;
            }

            if (str == "DIALUP.ICO")
            {
                return PwIcon.WorldSocket;
            }

            if (str == "SHOPING.ICO")
            {
                return PwIcon.ClipboardReady; // Sic
            }
            ...
            if (str == "MESSENGER.ICO")
            {
                return PwIcon.UserCommunication;
            }

            if (str == "SOFTWARE_SERIALS.ICO")
            {
                return PwIcon.CDRom;
            }

            if (str == "CREDITCARD.ICO")
            {
